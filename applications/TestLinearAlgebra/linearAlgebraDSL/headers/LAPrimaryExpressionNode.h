...
public:
    ...
    std::string toString() final {
        if (flag.compare("identifier") == 0) {
            ...
            return flag + "(" + child->toString() + "," +
                std::to_string(duplicateDim.blockRowSize) + "," +
                std::to_string(duplicateDim.blockRowNum) + ")";
        } else if (flag.compare("duplicateRow") == 0) {
            return flag + "(" + child->toString() + "," +
                std::to_string(duplicateDim.blockColSize) + "," +
                std::to_string(duplicateDim.blockColNum) + ")";
        } else {
