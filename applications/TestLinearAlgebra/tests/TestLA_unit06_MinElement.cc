...
int main(int argc, char* argv[]) {
    ...
    if (whetherToAddData) {
        ...
        pdbClient.sendData<MatrixBlock>("LA06_db", "LA_input_set", storeMe);
    ...
    if (printResult) {
        ...
        auto input_iter = pdbClient.getSetIterator<MatrixBlock>("LA06_db", "LA_input_set");
        ...
        auto output_iter = pdbClient.getSetIterator<LAMinElementOutputType>("LA06_db", "LA_min_set");
