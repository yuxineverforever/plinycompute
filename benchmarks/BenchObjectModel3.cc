...
static void BenchPDBVectorPop(benchmark::State &state) {
...
static void BenchNativeVectorPop(benchmark::State &state) {
...
BENCHMARK(BenchPDBVectorPop);
BENCHMARK(BenchNativeVectorPop);
