...
int main(int argc, char* argv[]) {
  ...
  fillSet(pdbClient, 2, "chris_db", "input_set3");
  ...
  myQuery1->setInput(0, myScanSet1);
  myQuery1->setInput(1, myScanSet2);
  Handle<Computation> myQuery2 = makeObject<IntUnion>();
  myQuery2->setInput(0, myQuery1);
  myQuery2->setInput(1, myScanSet3);
